"""End-to-end ML smoke: embeddings on subset + synthetic Cox train + model package."""
...
def main() -> None:
    ...
    print("\nTraining smoke finished. See docs/HUONG_DAN_HUAN_LUYEN.md for full cohort / Colab training.")
